...
- **개발자**: GitHub: Moonhm / GitHub: kyoyeonss
...
## 3. Git 저장소 구성 — ⚠️ 절대 규칙

```
mine    → https://github.com/Moonhm/2026-vibe-hackathon-dail-band-.git  (push 대상)
origin  → https://github.com/kyoyeonss/nolrugaja.git                     (절대 push 금지)
```

**`git push`는 반드시 `git push mine main` 만 사용**
`origin`은 kyoyeonss 저장소 — 절대 건드리지 말 것
...
git remote add origin https://github.com/kyoyeonss/nolrugaja.git
```
...
1. **`git push mine main` 만** — origin(kyoyeonss) push 절대 금지
